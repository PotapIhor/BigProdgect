...
//        System.out.println(" Kust " + testString1[3] + " = " + testString1[11] + " and " + testString1[15]);
        ...
        for (CurrencyValues currencyElement : responseStructure ) {
            System.out.println("Cur " + currencyElement.ccy
                    + " to " + currencyElement.base_ccy
                    + " has for buy " + currencyElement.buy
...
//    @Ignore
    public void getWeatherDetails() {
        ...
        ResponseStructureForRestAssuredTest responseStructure
                = responseBody.as(ResponseStructureForRestAssuredTest.class);
